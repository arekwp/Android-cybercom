...
public class BookDetailsActivity extends Activity
{
	...
	protected Void doInBackground(Void... params)
	{
	    ...
	    Book b = new Book(etId.getText().toString(), etISBN.getText()
		    .toString(), etName.getText().toString(), "", myApp.c
		    .getCategoryId().toString(), etAuthor.getText().toString());
	    
	    if (editMode)
	    {
		Log.v("calling", "updateBook " + b.getBookId());
