...
public class CategoryListActivity extends ListActivity
{
	...
	class GetCategoriesThread extends AsyncTask<String, Void, List<Category>>
	{
		...
		protected void onPostExecute(List<Category> result)
		{
			...
			// jeï¿½li uï¿½ytkownik wymusiï¿½ pobranie danych do SQLite i mamy
			// poï¿½ï¿½czenie z internetem to ...
			if (dumpToOffline && !myApp.isOffline())
			{
				Log.v("AsyncTask",
	...
	class SyncThread extends AsyncTask<String, Void, Void>
	{
		...
		protected Void doInBackground(String... url)
		{
			if (!myApp.isOffline())
			{
				...
				localCats.removeAll(remoteCats); // TODO porownywanie ksiazek ->
												 // pobieranie ksiazek z jax
