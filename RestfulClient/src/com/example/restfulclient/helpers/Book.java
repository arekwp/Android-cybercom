...
public class Book
{
    ...
    public Book(String id, String isbn, String name, String photo,
	    String catid, String bauthor)
    {
	bookId = id;
	bookISBNnumber = isbn;
	bookName = name;
    ...
    {
	boolean id = bookId != null && bookId.length() > 0 ? true : false;
	boolean name = bookName != null && bookName.length() > 0 ? true : false;
	boolean bauthor = author != null && author.length() > 0 ? true : false;
	boolean isbn = bookISBNnumber != null && bookISBNnumber.length() > 0 ? true
	        : false;

	return (id && name && bauthor && isbn) ? true : false;
    }
}
